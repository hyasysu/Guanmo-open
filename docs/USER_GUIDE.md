...
AI 会根据问题中的动作、目标、数据来源和上下文自动选择能力。想提高知识库、长期记忆或联网搜索的命中概率，请在问题中明确写出所需来源。完整示例见 [AI 能力路由与提问指南](./AI_ROUTING_GUIDE.md)。
