...
description: "Explicit opt-in only. Use only when the current user message explicitly requests Trellis channel or this trellis-channel skill; then use the Trellis multi-agent collaboration runtime."
---
