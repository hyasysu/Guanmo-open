...
description: "Explicit opt-in only. Use only when the current user message explicitly requests Trellis spec bootstrap or this trellis-spec-bootstrap skill; then create or refresh .trellis/spec guidelines."
---
