...
description: "Explicit opt-in only. Use only when the current user message explicitly requests Trellis brainstorming or this trellis-brainstorm skill; then guide requirements discovery and create Trellis task artifacts."
---
