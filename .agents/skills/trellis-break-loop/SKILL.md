...
description: "Explicit opt-in only. Use only when the current user message explicitly requests Trellis break-loop analysis or this trellis-break-loop skill; then analyze bug recurrence and capture prevention knowledge."
---
