---
name: trellis-start
description: "Explicit opt-in only. Use only when the current user message explicitly requests Trellis, starting a Trellis session, or this trellis-start skill; ordinary session or coding-task startup must not trigger it."
---
