---
name: trellis-meta
description: "Explicit opt-in only. Use only when the current user message explicitly requests Trellis customization, Trellis architecture work, or this trellis-meta skill; then modify local Trellis workflow and platform integration files."
---
