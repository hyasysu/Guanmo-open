...
description: "Explicit opt-in only. Use only when the current user message explicitly requests a Trellis spec update or this trellis-update-spec skill; ordinary debugging or implementation learnings must not trigger it."
---
