...
description: "Explicit opt-in only. Use only when the current user message explicitly requests Trellis finish-work or this trellis-finish-work skill; then archive tasks and record the Trellis journal."
---
