...
description: "Explicit opt-in only. Use only when the current user message explicitly requests continuing a Trellis task or this trellis-continue skill; then resume from the current workflow phase."
---
