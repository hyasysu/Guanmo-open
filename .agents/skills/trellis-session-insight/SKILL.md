...
description: "Explicit opt-in only. Use only when the current user message explicitly requests Trellis memory, trellis mem, or this trellis-session-insight skill; ordinary history lookup must not trigger it."
---
