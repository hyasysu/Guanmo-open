...
description: "Explicit opt-in only. Use only when the current user message explicitly requests Trellis or this trellis-before-dev skill; then load project-specific coding guidelines from .trellis/spec/ before implementation."
---
